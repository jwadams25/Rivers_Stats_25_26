...
3.  What are the observational units and how many are there?
    ...
    The observational units are counties in the United States. There are 3,142.
:::
...
-   I notice there are now two different color dots, one for counties with metro areas and one for counties without.

-   According to the lines, it looks like the rate of homeownership goes down more slowly as poverty rates increase in counties without a metro area compared to those with a metro area.

-   The strength of the associates are fairly strong.

-   The direction of the association between poverty and homeownership is negative.
